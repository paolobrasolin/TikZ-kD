...
\pgfqkeys{/kD}{
%
  node math contents/.style={/tikz/node contents={$#1$}},
%
  fallback to/.code args={#1=#2}{%
    \let\searchname=\pgfkeyscurrentname%
    \pgfkeysalso{
      /tikz/\searchname/.try=#2,
      #1/.retry/.expand once=\searchname,}},
%
  objects/.unknown/.style={/kD/fallback to={/kD/node math contents=#1}},
  arrows/.search also=/tikz,
  labels/.unknown/.style={/kD/fallback to={/kD/node math contents=#1}},
...
%
  ...
  /kD/labels/.cd,
    mid/.style={shape=circle,fill=white,anchor=center},
  /kD/lattices/.cd,
...
% ================================================================== RENDERING =
% Styles to render every kind of object are defined.
